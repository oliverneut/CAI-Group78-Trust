...
class ColorBlindAgent(BaseLineAgent):
                ...
                if action != None:
                    ...
                    for gb in self._goalBlocks:
                        for vb in self._visibleBlocks:
                            if vb['visualization']['size'] == gb['visualization']['size'] and vb['visualization']['shape'] == gb['visualization']['shape']:
    ...
    def randColor(self):
        return random.choice(self._goalBlocks)['visualization']['colour']
